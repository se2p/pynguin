...
class InjectionInstrumentationAdapter:
    """Abstract base class for byte-code injection instrumentation adapters.
...
class InjectionInstrumentationTransformer(InstrumentationTransformer):
    """Applies a given list of injection instrumentation adapters to code objects."""

    def __init__(  # noqa: D107
        self,
        subject_properties: tr.SubjectProperties,
        instrumentation_adapters: list[InjectionInstrumentationAdapter],
    ):
        super().__init__(subject_properties)
...
class CheckedCoverageInjectionInstrumentation(InjectionInstrumentationAdapter):
    ...
    def _instrument_attr_access(  # noqa: PLR0917
        ...
        new_block_instructions.extend([
            ...
            ArtificialInstr(
                "LOAD_CONST",
                self._subject_properties.instrumentation_tracer.__class__,  # type: ignore[arg-type]
                lineno=instr.lineno,
            ),
            ArtificialInstr(
                "LOAD_METHOD",
