...
"""Provides prompt class for combined readability + assertion refinement of a module."""
...
class ModuleRefinementPrompt(Prompt):
    """Prompt that refines readability and adds assertions for a whole module in one pass."""

    _resource_name = "module_refinement_combined"
