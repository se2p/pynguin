...
"""Provides prompt class for refining the readability of a whole test module."""
...
class ModuleReadabilityRefinementPrompt(Prompt):
    """Prompt for improving the readability of every test in a module at once."""

    _resource_name = "module_readability_refinement"
