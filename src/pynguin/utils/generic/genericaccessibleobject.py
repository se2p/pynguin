...
class GenericConstructor(GenericCallableAccessibleObject):
    ...
    def __init__(
        ...
        inferred_signature: InferredSignature,
        expected_exceptions: set[str] = frozenset(),  # type: ignore[assignment]
        generated_type: ProperType | None = None,
    ) -> None:
        ...
        Args:
            ...
            generated_type: The concrete type generated by this constructor
        """
        super().__init__(
            owner,
        ...
        self._generated_type = generated_type if generated_type is not None else Instance(owner)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GenericConstructor):
            return False
        return self._owner == other._owner and self._generated_type == other._generated_type

    def __hash__(self):
        return hash((self._owner, self._generated_type))
...
class GenericMethod(GenericCallableAccessibleObject):
    ...
    def __init__(
        ...
        *,
        instantiated_owner: Instance | None = None,
    ) -> None:
        ...
        Args:
            ...
            instantiated_owner: The optional instantiated owner type
        """
        ...
        self._instantiated_owner = instantiated_owner
    ...
    @property
    def instantiated_owner(self) -> Instance | None:
        """Returns the instantiated owner type if this method is specialized."""
        return self._instantiated_owner
    ...
    def get_dependencies(  # noqa: D102
        ...
        dependencies.add(
            self._instantiated_owner
            if self._instantiated_owner is not None
            else Instance(self.owner)
        )
        return dependencies
    ...
    def __eq__(self, other):
        ...
        return (
            ...
            and self._instantiated_owner == other._instantiated_owner
            and self._inferred_signature == other._inferred_signature
        )

    def __hash__(self):
        return hash((self._callable, self._instantiated_owner, id(self._inferred_signature)))
...
class GenericFunction(GenericCallableAccessibleObject):
    ...
    def __hash__(self):
        return hash((self._callable, id(self._inferred_signature)))
