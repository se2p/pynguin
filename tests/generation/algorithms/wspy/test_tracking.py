...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(Compare.EQ, 5, 0, 5, 0, id="EQ_1"),
        pytest.param(Compare.EQ, 0, 0, 0, 1, id="EQ_2"),
        pytest.param(Compare.NE, 5, 0, 0, 5, id="NE_1"),
        pytest.param(Compare.NE, 0, 0, 1, 0, id="NE_2"),
        pytest.param(Compare.LT, 5, 0, 6, 0, id="LT_1"),
        pytest.param(Compare.LT, 0, 5, 0, 6, id="LT_2"),
        pytest.param(Compare.LE, 5, 0, 6, 0, id="LE_1"),
        pytest.param(Compare.LE, 0, 5, 0, 6, id="LE_2"),
        pytest.param(Compare.GT, 5, 0, 0, 6, id="GT_1"),
        pytest.param(Compare.GT, 0, 5, 6, 0, id="GT_2"),
        pytest.param(Compare.GE, 5, 0, 0, 6, id="GE_1"),
        pytest.param(Compare.GE, 0, 5, 6, 0, id="GE_2"),
        pytest.param(Compare.IN, 0, [0], 0, 1, id="IN_1"),
        pytest.param(Compare.IN, 0, [1], 1, 0, id="IN_2"),
        pytest.param(Compare.NOT_IN, 0, [0], 1, 0, id="NOT_IN_1"),
        pytest.param(Compare.NOT_IN, 0, [1], 0, 1, id="NOT_IN_2"),
        pytest.param(Compare.IS, 0, 0, 0, 1, id="IS_1"),
        pytest.param(Compare.IS, 0, 1, 1, 0, id="IS_2"),
        pytest.param(Compare.IS_NOT, 0, 0, 1, 0, id="IS_NOT_1"),
        pytest.param(Compare.IS_NOT, 0, 1, 0, 1, id="IS_NOT_1"),
    ],
)
