...
def test_string_equals_true_comparison():
    tracer = ExecutionTracer()
...
def test_string_equals_distance(string1, string2, true_distance, false_distance):
    ...
    assert tracer.get_trace().true_distances == {0: true_distance}
    assert tracer.get_trace().false_distances == {0: false_distance}
...
def test_string_lt_distance(string1, string2, distance):
    tracer = ExecutionTracer()
    ...
    assert tracer.get_trace().true_distances == {0: distance}
    assert tracer.get_trace().false_distances == {0: 0.0 if distance != 0 else 1.0}
