...
# Markers
python38 = pytest.mark.skipif(sys.version_info >= (3, 9), reason="Works only with CPython 3.8")
python39plus = pytest.mark.skipif(sys.version_info < (3, 9), reason="Works only with CPython 3.9+")
