...
def filter_dictlist_by_dict(dict_filter: Dict[Any, Any],
                            list_to_filter: List[Dict[Any, Any]]) -> List[Dict[Any, Any]]:
    """
    ...
    """
    return [i for i in list_to_filter if all(
        i[target_key] == target_value
        for target_key, target_value in dict_filter.items())]


def dict_without_keys(dict_to_change: Dict[Any, Any],
                      keys: List[Any]) -> Dict[Any, Any]:
    """
