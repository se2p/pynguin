    ...
    def change_call(
        ...
        if call.is_method():
            ...
            parameters = self._get_reuse_parameters(
                test_case, method.inferred_signature.parameters, position
            )
            ...
            parameters = self._get_reuse_parameters(
                test_case, constructor.inferred_signature.parameters, position
            )
            ...
            parameters = self._get_reuse_parameters(
                test_case, funktion.inferred_signature.parameters, position
            )
