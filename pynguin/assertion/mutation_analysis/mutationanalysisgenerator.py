...
class MutationAnalysisGenerator(cv.ChromosomeVisitor):
    ...
    def __init__(self, executor: ex.TestCaseExecutor):
        ...
        self._global_assertions = set()
        self._field_assertions = set()
    ...
    @staticmethod
    def _mutate_module() -> List[Tuple[ModuleType, object]]:
    ...
    def _generate_assertions(self, test_cases: List[tc.TestCase]) -> None:
        ...
        for ref_dataframe in reference:
            ...
            mutated_dataframes = cs.CollectorStorage.get_dataframe_of_mutations(tc_id,
                                                                                pos)
            ...
            remainders = cu.dict_without_keys(ref_dataframe, [key_id,
                                                              key_pos,
                                                              key_retval,
                                                              key_global])
            ...
            for dataframe in mutated_dataframes:
                ...
                self._compare_globals(dataframe[key_global],
                                      ref_globals,
                                      statement)
                ...
                for key, ref_fragment in remainders.items():
                    ...
                    for frag_key, ref_frag_val in ref_fragment.items():
                        ...
                        if frag_key == key_cf:
                            # Class fields
                            self._compare_class_fields(frag_val,
                                                       pos,
                                                       ref_frag_val,
                                                       statement,
                                                       test_case)
                            ...
                            # Object attributes
                            self._compare_object_attributes(frag_val,
                                                            pos,
                                                            ref_frag_val,
                                                            statement,
                                                            test_case)

    def _compare_class_fields(self,
                              frag_val: Dict[Any, Any],
                              pos: int,
                              ref_frag_val: Dict[Any, Any],
                              statement: st.Statement,
                              test_case: tc.TestCase) -> None:
        for field, ref_value in ref_frag_val.items():
            ...
            if ref_value != value:
                ...
                assertion = fa.FieldAssertion(None,
                                              ref_value,
                                              field,
                                              None,
                                              [obj_class])
    ...
    def _compare_object_attributes(self,
                                   frag_val: Dict[Any, Any],
                                   pos: int,
                                   ref_frag_val: Dict[Any, Any],
                                   statement: st.Statement,
        ...
        for field, ref_value in ref_frag_val.items():
            ...
            if ref_value != value:
                obj_vr = self._get_current_object_ref(test_case, pos)
                assertion = fa.FieldAssertion(obj_vr,
                                              ref_value,
                                              field)
                if assertion not in self._field_assertions:
                    self._field_assertions.add(assertion)
    ...
    def _compare_globals(self,
                         globals_frame: Dict[Any, Any],
                         globals_frame_ref: Dict[Any, Any],
                         statement: st.Statement) -> None:
        for module_alias in globals_frame_ref.keys():
            for global_field, ref_value in globals_frame_ref.get(module_alias).items():
    ...
    @staticmethod
    def _compare_return_value(dataframe: Dict[Any, Any],
                              ref_rv: Any,
                              statement: st.Statement,
                              key_retval: str) -> None:
        rv = dataframe.get(key_retval)
        if rv != ref_rv:
    ...
    @staticmethod
    def _get_testcase_by_id(test_cases: List[tc.TestCase],
                            test_case_id: int) -> Optional[tc.TestCase]:
    ...
    @staticmethod
    def _get_statement_by_pos(test_case: tc.TestCase,
                              position: int) -> Optional[st.Statement]:
    ...
    @staticmethod
    def _get_current_object_ref(test_case: tc.TestCase,
    ...
    @staticmethod
    def _get_current_object_class(var_ref: vr.VariableReference) -> Optional[str]:
        if var_ref:
