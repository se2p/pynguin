...
class CollectionObserver(eo.ExecutionObserver):
    ...
    def after_test_case_execution(self, test_case: tc.TestCase,
                                  result: res.ExecutionResult) -> None:
        self._clear()
    ...
    def after_statement_execution(self, statement: stmt.Statement,
        ...
        if isinstance(statement,
            ...
            # Collect the states
            cs.CollectorStorage.collect_states(test_case_id=test_case_id,
